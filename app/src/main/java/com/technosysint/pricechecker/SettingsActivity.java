...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference, String type) {
        ...
        } else if (type == "Boolean") {sBindPreferenceSummaryToValueListener.onPreferenceChange(preference,
                PreferenceManager
                        .getDefaultSharedPreferences(preference.getContext())
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            /*Adnan Changes*/
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_technosys_webapi_key)), "String");
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_technosys_Database_key)), "String");
        }
